# Redux 5
  ...
  - [1 Adding a Fake Backend to the Project](#1-adding-a-fake-backend-to-the-project)
  - [Fetching Data on Route Change](#fetching-data-on-route-change)
  - [3 Dispatching Actions with the Fetched Data](#3-dispatching-actions-with-the-fetched-data)
  - [4 Wrapping dispatch() to Recognize Promises](#4-wrapping-dispatch-to-recognize-promises)
  - [5 The Middleware Chain](#5-the-middleware-chain)
  - [6 Applying Redux Middleware](#6-applying-redux-middleware)
  - [7 Updating the State with the Fetched Data](#7-updating-the-state-with-the-fetched-data)
  - [8 Refactoring the Reducers](#8-refactoring-the-reducers)

## 1 Adding a Fake Backend to the Project
...
## 3 Dispatching Actions with the Fetched Data
...
## 4 Wrapping dispatch() to Recognize Promises
...
## 7 Updating the State with the Fetched Data
